defmodule DujuduWeb.IngredientViewTest do
  ...
  describe "resize_wikidata_image/2" do
    ...
    test "returns proper url for url with spaces" do
      ...
      expected_url = "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/990515_%2815%29_-_Green_Slim_Peppers.jpg/320px-990515_%2815%29_-_Green_Slim_Peppers.jpg"
